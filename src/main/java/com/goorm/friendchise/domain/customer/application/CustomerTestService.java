...
public class CustomerTestService
{
    ...
    private static final Logger log = LoggerFactory.getLogger(CustomerTestService.class);
    ...
    public String findNearestStore(CustomerRecommendStoreRequest customerRecommendStoreRequest) {
    ...
    private String calculateNearestStore(String address, String franchiseName) {
        return CompletableFuture
                ...
                .thenApply(customerCoordinates -> {
                    List<StoreRedisDto> stores = storeService.fetchAndCacheStoresFromDB();
